...
if(!class_exists('Event_Plus_Features')){
	class Event_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			<a title="<?php esc_html_e( 'Upgrade to Plus', 'event' ); ?>" href="<?php echo esc_url( 'https://themefreesia.com/plugins/event-plus/' ); ?>" target="_blank" id="about_event">
			<?php esc_html_e( 'Upgrade to Plus', 'event' ); ?>
			</a><br/>
			...
			<a href="<?php echo esc_url( 'http://themefreesia.com/support-forum/' ); ?>" title="<?php esc_html_e( 'Forum', 'event' ); ?>" target="_blank" id="about_event">
